...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_K,    KC_M, KC_COMM,  KC_DOT, XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //,        ,        ,    =   ,    '   ,    (   ,    )   ,                    ,    /   ,        ,        ,        ,        ,        ,
        KC_LT,   KC_GT, KC_PEQL, KC_QUOT, KC_LPRN, KC_RPRN,                      KC_PSLS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_DEL,
  //|        +        +    :   +    "   +    [   +    ]   |                    ,        ,        ,        ,        ,        ,        ,
        KC_AT,  KC_DLR, KC_COLN, KC_DQUO, KC_LBRC, KC_RBRC,                      KC_PIPE, KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT,        ,
  //|        +        +        +        +    {   +    }   |                    ,    \   ,        ,        ,        ,        ,        ,
      KC_CIRC, _______, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR,                      KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,        ,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
